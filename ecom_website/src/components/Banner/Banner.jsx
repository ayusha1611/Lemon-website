      ...
      <div className="container">
         <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 items-center'>
            ...
            <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                ...
                <p 
                data-aos="fade-up"
                className='text-sm: text-[#393c51] tracking-wide leading-5 '>
                ...
                > 
                    <GrSecure
                    className='text-4xl h-12 w-12 shadow-sm p-4 rounded-full bg-violet-100 dark:bg-violet-400 font-bold'/>
                <p> Quality Products </p>
                </div>
                <div data-aos="fade up" className='flex items-center gap-4'>
                    <IoFastFood className='text-4xl h-12 w-12 shadow:sm p-4 rounded-full bg-orange-100 dark:bg-orange-400 font-bold'/>
                    <p>Fast Delivery</p>
                </div>
                <div data-aos="fade-up" className='flex items-center gap-4'>
